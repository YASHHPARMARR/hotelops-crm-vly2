...
export const ROLE_NAVIGATION = {
  ...
  [ROLES.FRONT_DESK]: [
    ...
    { name: "Profile", path: "/front-desk/profile", icon: "User" },
  ],
  [ROLES.HOUSEKEEPING]: [
    ...
    { name: "Profile", path: "/housekeeping/profile", icon: "User" },
  ],
  [ROLES.RESTAURANT]: [
    ...
    { name: "Profile", path: "/restaurant/profile", icon: "User" },
  ],
  [ROLES.SECURITY]: [
  ...
  [ROLES.MAINTENANCE]: [
    ...
    { name: "Profile", path: "/maintenance/profile", icon: "User" },
  ],
  [ROLES.TRANSPORT]: [
    ...
    { name: "Profile", path: "/transport/profile", icon: "User" },
  ],
  [ROLES.INVENTORY]: [
